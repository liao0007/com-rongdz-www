...
case class SaleFilter(idOpt: Option[Long] = None,
  ...
  lazy val subcategory: Option[Subcategory] = subcategoryIdOpt.flatMap(subcategoryId => Subcategory.find(subcategoryId))
}
...
object SaleFilter {
  ...
  implicit def queryStringBinder(implicit longBinder: QueryStringBindable[Long],
                                 ...
                                 stringBinder: QueryStringBindable[String]): QueryStringBindable[SaleFilter] =
