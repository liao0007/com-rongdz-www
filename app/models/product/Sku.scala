...
case class Sku(
  ...
  lazy val product: ActiveRecord.BelongsToAssociation[Sku.this.type, Product] = belongsTo[Product]
  lazy val sales: ActiveRecord.HasManyAssociation[Sku.this.type, Sale] = hasMany[Sale]
  lazy val attributeValueSet: ActiveRecord.BelongsToAssociation[Sku.this.type, AttributeValueSet] = belongsTo[AttributeValueSet]
